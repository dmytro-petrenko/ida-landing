...
type WindowFirstProps = {
  windowHandler: () => void;
};

const WindowFirst: FC<WindowFirstProps> = ({ windowHandler }) => {
  return (
    <div className="block msm:w-112 mx-3 msm:mx-auto xl:ml-32 mb-12.5 lg:mb-0 rounded-lg bg-gray-50 shadow-xl py-8 px-5 lg:px-8 py-8 z-50">
      <div className="mb-6">
        <h4 className="font-inter font-medium text-sm text-gray-600 mb-2">Question 1 of 3</h4>
